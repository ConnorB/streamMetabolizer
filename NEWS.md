...
platform- and toolchain-safe persistent executable caching, parameter-filtered
summaries, durable retained fit objects, correct indexed posterior plots,
CmdStan-based syntax checks, and clearer setup and sampling errors
