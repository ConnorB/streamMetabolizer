...
```{r, eval=identical(tolower(Sys.getenv("STREAMMETABOLIZER_RUN_STAN_VIGNETTE")), "true")}
mm
```
...
```{r, fig.width=5, fig.height=5, eval=identical(tolower(Sys.getenv("STREAMMETABOLIZER_RUN_STAN_VIGNETTE")), "true")}
mcmc <- get_mcmc(mm)
