...
[`streamMetabolizer`](https://github.com/DOI-USGS/streamMetabolizer). Report
issues with this fork at <https://github.com/ConnorB/streamMetabolizer/issues>.
...
If you are installing from GitHub, it is helpful to set a [GitHub Personal Access Token (PAT)](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens). There are [several methods](https://usethis.r-lib.org/articles/git-credentials.html) for setting your PAT within R; a simple approach is:
...
The rendered vignettes are available as articles on the [package website](https://connorb.github.io/streamMetabolizer/articles/).
...
The original USGS project is archived and its project funding has ended. Its
source and historical documentation remain available from the
[`DOI-USGS/streamMetabolizer`](https://github.com/DOI-USGS/streamMetabolizer)
repository. This fork contains subsequent enhancements and bug fixes and is
