...
1.  [`mm_name()`](https://connorb.github.io/streamMetabolizer/dev/reference/mm_name.md)
    chooses a model structure.

2.  [`specs()`](https://connorb.github.io/streamMetabolizer/dev/reference/specs.md)
    sets model specifications.

3.  [`metab()`](https://connorb.github.io/streamMetabolizer/dev/reference/metab.md)
    fits the model.
