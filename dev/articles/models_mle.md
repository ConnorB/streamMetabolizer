...
Structures](https://connorb.github.io/streamMetabolizer/dev/articles/model_structures.md)
and [GPP and ER
equations](https://connorb.github.io/streamMetabolizer/dev/articles/gpp_er_eqs.md)),
...
```
    ...
    Specifications:
      ...
      init.ER.daily     -1
      init.K600.daily   3
    Fitting time: 0.419 secs elapsed
    Parameters (3 dates):
