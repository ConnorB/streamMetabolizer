...
because the compiler toolchain (and, for CmdStanR, CmdStan itself) must
also be configured. See the [RStan installation
...
After installing and loading `streamMetabolizer`, run
[`vignette()`](https://rdrr.io/r/utils/vignette.html) in R to see
tutorials on getting started and customizing your metabolism models.
